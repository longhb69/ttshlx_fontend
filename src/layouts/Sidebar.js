...
export default function SideBar() {
  ...
  return (
    <div className={`${collapse ? 'relative w-[16px] z-[5]' : 'relative w-[150px]'} h-full min-h-full font-[14px] font-normal leading-5 bg-[#67879D]/[0.9]`}>
      ...
      <div className="absolute top-0 bottom-0 left-0 transition w-[16px]">
        <div className={`${collapse ? '' : 'hidden'} flex flex-col items-center h-full min-h-full bg-[#67879D]/[0.9]`}>
            <button 
                className="bg-[#67879D]/[0.9] flex flex-col justify-between w-full h-full m-0 p-0"
